                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full 
                                @if($booking->user->hasRole('admin')) bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-400
                                @elseif($booking->user->hasRole('hotel_owner')) bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400
                                @elseif($booking->user->hasRole('ferry_operator')) bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400
                                @else bg-gray-100 text-gray-800 dark:bg-gray-900/20 dark:text-gray-400 @endif">
                                {{ $booking->user->getRoleNames()->first() ?? 'No Role' }}
                            </span>
                        </div>
                    </div>
