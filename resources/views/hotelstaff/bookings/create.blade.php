<x-app-layout>
    <x-sidebar :menuItems="$menuItems" title="Create Booking">
        <div class="space-y-6">
            <!-- Header -->
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Create New Booking</h1>
                    <p class="text-gray-600 dark:text-gray-400">Create a new booking for a guest.</p>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
                <form method="POST" action="{{ route('hotelstaff.bookings.store') }}">
                    @csrf
