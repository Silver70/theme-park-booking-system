<x-app-layout>
    <x-sidebar :menuItems="$menuItems" title="Create Ferry Schedule">
        
        <!-- Page Header -->
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Create Ferry Schedule</h1>
                    <p class="text-gray-600 mt-2">Add a new ferry departure to your schedule</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <form action="{{ route('ferry.schedules.store') }}" method="POST" id="scheduleForm" class="space-y-6">
                @csrf
                ...
                <div class="px-8 py-6  border-gray-200">
                    ...
                    <p class="text-gray-600 mt-1">Fill in the ferry schedule information below</p>
                </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="relative">
                                ...
                                <select name="origin" id="origin" required
                                    ...
                                    <option value="Male International Airport" {{ old('origin') == 'Male International Airport' ? 'selected' : '' }}>Male International Airport</option>
                                    <option value="Paradise Resort" {{ old('origin') == 'Paradise Resort' ? 'selected' : '' }}>Paradise Resort</option>
                            ...
                            <div class="relative">
                                ...
                                <select name="destination" id="destination" required
                                    ...
                                    <option value="Male International Airport" {{ old('destination') == 'Male International Airport' ? 'selected' : '' }}>Male International Airport</option>
                                    <option value="Paradise Resort" {{ old('destination') == 'Paradise Resort' ? 'selected' : '' }}>Paradise Resort</option>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="seats_available" id="seats_available" 
                                       value="{{ old('seats_available', 50) }}" required min="1" max="200"
        ...
        <!-- Preview Card -->
        <div class="mt-8 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden" id="previewCard" style="display: none;">
