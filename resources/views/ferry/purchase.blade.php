                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('ferry.store-ticket') }}" class="space-y-6">
                        ...
                        <div class="flex items-center justify-between pt-4">
                            <a href="{{ route('schedules.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md font-semibold text-xs text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    ...
                    @if($schedules->count() > 0)
                        ...
                        @if($schedules->count() > 4)
                            <div class="mt-4 text-center">
                                <a href="{{ route('schedules.index') }}" class="text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300">
